...
#sumoBinary = "/home/wuyuankai/Downloads/sumo-0.32.0/bin/sumo"
...
class rm_vsl_co(object):
    ...
    def __init__(self, test = False, visualization = False, control_horizon = 60, incidents = False):
        ...
        if self.visualization == False:
            self.sumoBinary = "/home/wuyuankai/Downloads/sumo-0.32.0/bin/sumo"
        else:
            self.sumoBinary = "/home/wuyuankai/Downloads/sumo-0.32.0/bin/sumo-gui"
    ...
    def run_step(self, v):
        ...
        for i in range(self.control_horizon):
            ...
            if self.simulation_step == self.incident_time:
                ...
                self.inci_edge = traci.vehicle.getRoadID(self.inci_veh)
                print self.inci_edge                                           # get incident edge
